...
<body class="home blog woocommerce theme-dokan woocommerce-no-js dokan-theme-dokan" style="background-color:#EDEDED">
...
<div class="container">
        ...
        <div class="col-md-8">
				<div class="card">
				<div class="card-header">预订房间</div>
				<div class="card-body">
				<form action="BookAction" method="post" enctype="multipart/form-data">
				<div class = "form-group row">
				<label for="catelog_id" class="col-sm-3 col-form-label">选择预订房间类型：</label>
							<div class="col-sm-7">
								<select class="form-control" id="catelog_id" name="catelog_id">
			...
			<div class="col-md-4">
	<div class="card">
		<div class="card-header">关于单人房</div>
		<div class="card-body">
			<h2 class="card-title">基本信息</h2>
			<p class="card-text">面积:32平方米</p>
			<p class="card-text">床型:单人床(该房型不可加床)</p>
			<p class="card-text">楼层:3-4楼</p>
