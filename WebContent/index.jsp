...
<style>.woocommerce-password-strength.short {color: #e2401c}.woocommerce-password-strength.bad {color: #e2401c}.woocommerce-password-strength.good {color: #3d9cd2}.woocommerce-password-strength.strong {color: #0f834d}</style>	<noscript><style>.woocommerce-product-gallery{ opacity: 1 !important; }</style></noscript>
  ...
  gtag('config', 'UA-67613229-3');
    ...
    <body class="home blog woocommerce theme-dokan woocommerce-no-js dokan-theme-dokan">
...
<li id="menu-item-1538" class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-1538"><a  href="taofang.jsp">套房</a></li>
  ...
  <div class="container">
    <img src="images/酒店9.jpg" style="width=100%" class="img-fluid">
    <h1>酒店客房预订系统</h1>
    <h5 class="text-gray-soft text-regular">Hotel room reservation system, you can book the room you want on the system.</h5>
    <a class="button button-brand btn-lg mb-5 mb-lg-2" href="book.jsp">去看看预订！</a>
  </div>
...
<section class="section">
    <div class="container">
                ...
                <div class="theme-cards__heading">
                    <div>
                        <h5 class="theme-cards__title">房型信息</h5>
                        <p class="text-gray-soft">Information about various types of rooms.</p>
                    </div>
    ...
    <div class="theme-card">
        <div class="theme-card__body">
            <a class="d-block" href="danrenfang.jsp">
                <img src="images/单人房.jpg" style="margin: auto;">
            </a>

            <a class="theme-card__body__overlay btn btn-brand btn-sm" href="book.jsp">预订</a>
        </div>
        <div class="theme-card__footer">
            <div class="theme-card__footer__item"><a class="theme-card__title mr-1" href="danrenfang.jsp">单人房</a>
                <p class="theme-card__info">单人床，可入住1人</p>
            </div>
            <div class="theme-card__footer__item">
                <p class="theme-card__price">153元/晚</p>
                <ul class="rating">
    ...
    <div class="theme-card">
        <div class="theme-card__body">
            <a class="d-block" href="dachuangfang.jsp">
                <img src="images/大床房1.jpg" style="margin: auto;">
            </a>

            <a class="theme-card__body__overlay btn btn-brand btn-sm" href="book.jsp">预订</a>
        </div>
        <div class="theme-card__footer">
            <div class="theme-card__footer__item"><a class="theme-card__title mr-1" href="dachuangfang.jsp">大床房</a>
                <p class="theme-card__info">双人大床，可入住1-2人</p>
            </div>
            <div class="theme-card__footer__item">
                <p class="theme-card__price">228元/晚</p>
                <ul class="rating">
                    <li class="rating__item rating__item--active"></li><li class="rating__item rating__item--active"></li><li class="rating__item rating__item--active"></li><li class="rating__item rating__item--active"></li><li class="rating__item rating__item--active"></li>                </ul>
            </div>
        </div>
    ...
    <div class="theme-card">
        <div class="theme-card__body">
            <a class="d-block" href="shuangchuangfang.jsp">
                <img src="images/双床房.jpg">
            </a>

            <a class="theme-card__body__overlay btn btn-brand btn-sm" href="book.jsp">预订</a>
        </div>
        <div class="theme-card__footer">
            <div class="theme-card__footer__item"><a class="theme-card__title mr-1" href="shuangchuangfang.jsp">双床房</a>
                <p class="theme-card__info">两张单人床，可入住1-2人</p>
            </div>
            <div class="theme-card__footer__item">
                <p class="theme-card__price">236元/晚</p>
                <ul class="rating">
                    <li class="rating__item rating__item--active"></li><li class="rating__item rating__item--active"></li><li class="rating__item rating__item--active"></li><li class="rating__item rating__item--active"></li><li class="rating__item rating__item--active"></li>                </ul>
            </div>
        </div>
    ...
    <div class="theme-card">
        <div class="theme-card__body">
            <a class="d-block" href="qinzifang.jsp">
                <img src="images/亲子房.jpg">
            </a>

            <a class="theme-card__body__overlay btn btn-brand btn-sm" href="book.jsp">预订</a>
        </div>
        <div class="theme-card__footer">
            <div class="theme-card__footer__item"><a class="theme-card__title mr-1" href="qinzifang.jsp">亲子房</a>
                <p class="theme-card__info">两张双人大床，可入住1-4人</p>
            </div>
            <div class="theme-card__footer__item">
                <p class="theme-card__price">308元/晚</p>
                <ul class="rating">
                    <li class="rating__item rating__item--active"></li><li class="rating__item rating__item--active"></li><li class="rating__item rating__item--active"></li><li class="rating__item rating__item--active"></li><li class="rating__item rating__item--active"></li>                </ul>
            </div>
        </div>
    ...
    <div class="theme-card">
        <div class="theme-card__body">
            <a class="d-block" href="shangwufang.jsp">
                <img src="images/商务房1.jpg">
            </a>

            <a class="theme-card__body__overlay btn btn-brand btn-sm" href="book.jsp">预订</a>
        </div>
        <div class="theme-card__footer">
            <div class="theme-card__footer__item"><a class="theme-card__title mr-1" href="shangwufang.jsp">商务房</a>
                <p class="theme-card__info">双人大床，可入住1-2人</p>
            </div>
            <div class="theme-card__footer__item">
                <p class="theme-card__price">476元/晚</p>
                <ul class="rating">
                    <li class="rating__item rating__item--active"></li><li class="rating__item rating__item--active"></li><li class="rating__item rating__item--active"></li><li class="rating__item rating__item--active"></li><li class="rating__item rating__item--active"></li>                </ul>
            </div>
        </div>
    ...
    <div class="theme-card">
        <div class="theme-card__body">
            <a class="d-block" href="taofang.jsp">
                <img src="images/套房1.jpg">
            </a>

            <a class="theme-card__body__overlay btn btn-brand btn-sm" href="book.jsp">预订</a>
        </div>
        <div class="theme-card__footer">
            <div class="theme-card__footer__item"><a class="theme-card__title mr-1" href="taofang.jsp">套房</a>
                <p class="theme-card__info">双人大床，可入住1-2人</p>
            </div>
            <div class="theme-card__footer__item">
                <p class="theme-card__price">766元/晚</p>
                <ul class="rating">
                    <li class="rating__item rating__item--active"></li><li class="rating__item rating__item--active"></li><li class="rating__item rating__item--active"></li><li class="rating__item rating__item--active"></li><li class="rating__item rating__item--active"></li>                </ul>
            </div>
        </div>
        ...
        <footer class="footer">
            <div class="container">
                <div class="footer__inner">
                                ...
                                <form action="//getbootstrap.us13.list-manage.com/subscribe/post?u=e3428dd6b8fda73bc5ba8b6e6&amp;id=198881a019" method="post" id="mc-embedded-subscribe-form"  name="mc-embedded-subscribe-form" target="_blank" novalidate>
                                    <div class="d-md-flex justify-content-between align-items-center">
                                        <div class="form-group">
                                            <h5 class="mb-1">如在预订房间的过程中遇到任何问题，请联系我们。</h5>
                                            <div class="form-text mt-0">联系邮箱：1289101671@qq.com</div>
                                            <div class="form-text mt-0">联系电话：19858191671</div>
                                        </div>
                        ...
                        <ul id="menu-seller-footer" class="nav sub-nav footer__sub-nav"><li id="menu-item-1333" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1333"><a title="Help Center" href="https://themes.zendesk.com/hc/en-us">帮助中心</a></li>
<li id="menu-item-1335" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1335"><a title="Terms of Service" href="https://themes.getbootstrap.com/terms/">服务条件</a></li>
<li id="menu-item-1334" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1334"><a title="Licenses" href="https://themes.getbootstrap.com/licenses/">许可证</a></li>
</ul>                        <p class="hidden-sm-down d-none d-lg-block">如有卡顿现象，请尝试 <a href="index.jsp">刷新</a>。</p>
                    </div>
                </div>
            </div>
        </footer>
